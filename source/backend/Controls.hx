...
class Controls
{
    ...
    */
	...
	private function get_NOTE_RIGHT_P() return justPressed('note_right');
    	...
    	private function get_SHIFT_P() return justPressed('shift');
	...
	private function get_SHITF() return pressed('shift');
	...
	private function get_SHIFT_R() return justReleased('shift');
