	...
	public function new():Void
	{
        ...
        if (ClientPrefs.data.hitboxExtend != true){
            ...
            if (ClientPrefs.data.hitboxLocation == 'Bottom'){
		        ...
		        add(buttonLeft = createHint(0, (FlxG.height / 5) * 0.5, Std.int(FlxG.width / 4), Std.int(FlxG.height * 0.8), 0xFF00FF));
		        add(buttonDown = createHint(FlxG.width / 4, (FlxG.height / 5) * 0.5, Std.int(FlxG.width / 4), Std.int(FlxG.height * 0.8), 0x00FFFF));
		        add(buttonUp = createHint(FlxG.width / 2, (FlxG.height / 5) * 0.5, Std.int(FlxG.width / 4), Std.int(FlxG.height * 0.8), 0x00FF00));
		        add(buttonRight = createHint((FlxG.width / 2) + (FlxG.width / 4), (FlxG.height / 5) * 0.5, Std.int(FlxG.width / 4), Std.int(FlxG.height * 0.8), 0xFF0000));
